...
namespace GeradorDadosOtimizacaoArtigoSBPO
{
    public static class RMCTDP
    {
        public static void Execute(string path)
        {
            ...
            int nD = 2;
            file.WriteLine($"nLP = {nD};");

            int nV = 2;
            file.WriteLine($"nCTM = {nV};");

            int nC = 11;
            file.WriteLine($"nCT = {nC};");
            ...
            FuncoesGerais.GenerateRandomArray(d, 10, 10, nN);
            for (int r = 0; r < nD; r++)
            {
            ...
            FuncoesGerais.GenerateRandomArray(p, 5520, 5535, nN);
            for (int r = 0; r < nD; r++)
            {
            ...
            int[] cfr = new int[nN];
            FuncoesGerais.GenerateRandomArray(cfr, 2, 2, nN);
            for(int i = 0; i < nD; i++)
            {
                cfr[i] = 0;
                cfr[nN - i - 1] = 0;
            }
            FuncoesGerais.WriteArrayToFile(file, cfr, nN, "cfr");

            float M = 2000;
            file.WriteLine($"M = {M};");

            float MjobShop = 2000;
            file.WriteLine($"MjobShop = {MjobShop};");
